package com.harambase.pioneer.social.qq;

import com.alibaba.fastjson.JSONObject;
import com.google.protobuf.ServiceException;
import com.harambase.pioneer.social.DefaultAuthServiceImpl;
...
public class QQAuthServiceImpl extends DefaultAuthServiceImpl implements QQAuthService {
    ...
    // 下面的属性可以通过配置读取
//    private static final String CALLBACK_URL = "http://192.168.1.3:30000/system/login/qq/response"; // QQ 在登陆成功后回调的 URL，这个 URL 必须在 QQ 互联里填写过
    private static final String CALLBACK_URL = "http://www.xianfengedu.cn/system/login/qq/response"; // QQ 在登陆成功后回调的 URL，这个 URL 必须在 QQ 互联里填写过
    private static final String API_KEY = "101551194";                                      // QQ 互联应用管理中心的 APP ID
    private static final String API_SECRET = "b7d933a99b4f9cb2950f15d8f4d0e8b0";               // QQ 互联应用管理中心的 APP Key
    ...
    public JSONObject ConvertToJson(String string) {
        ...
        logger.info("ConvertToJson s = " + string);
